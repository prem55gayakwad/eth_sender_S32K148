...
- {id: ENET0_CLK.outFreq, value: 48 MHz}
...
- {id: FTM6_CLK.outFreq, value: 8 MHz}
- {id: FTM7_CLK.outFreq, value: 8 MHz}
- {id: FlexIO0_CLK.outFreq, value: 8 MHz}
- {id: LPI2C0_CLK.outFreq, value: 8 MHz}
- {id: LPI2C1_CLK.outFreq, value: 8 MHz}
...
- {id: QSPI0_2x_SFIF_CLK.outFreq, value: 56 MHz}
- {id: QSPI0_CLK.outFreq, value: 48 MHz}
- {id: QSPI0_MODULE_CLK.outFreq, value: 48 MHz}
- {id: QSPI0_SFIF_CLK.outFreq, value: 28 MHz}
- {id: QSPI0_SFIF_CLK_HYP_PREMUX.outFreq, value: 28 MHz}
- {id: RTC0_CLK.outFreq, value: 48 MHz}
- {id: RTC_CLK.outFreq, value: 48 MHz}
- {id: SAI0_CLK.outFreq, value: 48 MHz}
- {id: SAI1_CLK.outFreq, value: 48 MHz}
...
- {id: PCC.ENET0_CLK_SEL.sel, value: SCG.FIRCDIV1_CLK}
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    ...
    .simConfig = 
    {
        ...
        .qspiRefClkGating = 
        {
            .enableQspiRefClk = true, /*!< QSPI internal reference clock gate       */
        },
        .tclkConfig = 
        {
